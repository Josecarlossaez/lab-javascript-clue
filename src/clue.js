...
const suspectsArray = [
    ...
    function selectRandom(arrayOfCluedo) {
        let randomCard = Math.random() * arrayOfCluedo.length
        let randomPosition = Math.floor(randomCard)
        return arrayOfCluedo[randomPosition]
